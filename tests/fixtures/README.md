...
- **standings_sample.html** — Minimal CBS standings page with 2 divisions and 4 teams. Tests division grouping, win/loss/tie parsing, points totals, and derived fields (games_played, ppg).
